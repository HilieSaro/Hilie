...
onmouseout="swapBack(this);" alt="Survolez moi !"></h2>
	...
	<button onclick="afficherPosition()">Clique pour connaître tes coordonnées</button><br>
		<A HREF="https://www.coordonnees-gps.fr/">💎 vérifie sur la carte de France si tu es bien chez toi!</A>
	<div id="resultat"></div></p></aside>
<footer>
